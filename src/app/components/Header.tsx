...
const Header = (props: {
    ...
    return (
        <header className="flex font-bold text-lg justify-between flex-wrap text-white text-[17px]">
            ...
            <div className="flex items-center whitespace-nowrap flex-wrap">
                ...
                <Link className="block px-5 py-0 bg-transparent border border-white h-max content-center rounded-[13px] leading-[26px] cursor-pointer font-ProximaNova font-semibold text-15 text-white mr-[15px] no-underline transition-transform duration-500 ease-in-out min-h-[26px] mt-4 hover:brightness-50" href={`tel:${+749555555555}`} target="blank">
                    ПОЗВОНИТЬ
                </Link>
